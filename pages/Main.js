...
شیک پوشان
              ...
              <Link href={`../Callus`} className={isActive ? 'link-top  darker-w ' : ' hover'}>

                تماس با ما
              </Link>

              <Link href={`../About`} className={isActive ? 'link-top   darker-w' : 'hover'}>

                آشنایی با ما
              </Link>

              <Link href={`../products-list`} className={isActive ? 'link-top darker-w' : 'hover'}>
              ...
              <Link href={`../firstpage`} className={isActive ? 'link-top   darker-w ' : 'hover  '}>
                خانه
              </Link>
            </div>
        ...
        <div className='title-cards'>
          ...
          <div className={isActive ? 'women-flipcard' : 'women-flipcard'} >
            ...
            <div className="flip-card women-flip">
              ...
              <div className="flip-card-inner">
                <div className="flip-card-front">
                  ...
                  <Image
                    ...
                    height={500}
                    alt="Picture of the author"
                    className={isActive ? 'front-image light' : 'front-image light'} >
            ...
            <p className={isActive ? 'women-description-right' : 'women-description-right morebluedark'} >
          ...
          <div className={isActive ? 'men-flipcard' : 'dark-men-flip-card'} >
            ...
            <div className="flip-card men-flip">
              ...
              <div className="flip-card-inner">
                <div className="flip-card-front">
                  ...
                  <Image
                    ...
                    height={500}
                    alt="Picture of the author"
                    className={isActive ? 'front-image light' : 'front-image '} >
        ...
        <div className={isActive ? 'parent-recipes' : 'parent-recipes black-res '} >
          ...
          <div className={isActive ? 'left-recipe' : 'left-recipe left-black-rec'}
        ...
        <footer className={isActive ? classes.footer : classes.footerblack}>
          ...
          <div className='parent-footer'>
            ...
            <div className='child-nav ff'>    <ul className={isActive ? 'ul-footer b' : 'ul-footer b ul-dark'}>
              ...
              <li href={`root`} className={isActive ? 'li-footer no-border' : 'lifooterblack no-border'}>
                دسترسی سریع
              </li>
              ...
              <ul className={isActive ? 'ul-footer' : 'ul-footer ul-dark'}>
                ...
                <li href={`Products-list`} className={isActive ? 'li-footer no-border' : 'lifooterblack no-border'}>
